...
STATUS: V0 HEURISTIC. Every number in this file is a judgment-based starting
point, NOT a backtested or sector-calibrated threshold. The scoring engine
attaches this caveat to every output. Calibration path: docs/roadmap.md.
...
BLOCKS: list[BlockSpec] = [
    ...
    BlockSpec(
        ...
        metrics=[
            MetricSpec("inventory_growth_spread", 0.35, [(0.0, 20), (0.10, 45), (0.30, 70), (0.60, 90)]),
            MetricSpec("dio_trend", 0.30, [(0.0, 25), (5.0, 45), (15.0, 70), (30.0, 90)]),
            MetricSpec("working_capital_swing_to_income", 0.35, [(0.2, 15), (0.5, 35), (1.0, 60), (2.0, 85)]),
        ],
    ),
    BlockSpec(
        ...
        metrics=[
            ...
            MetricSpec("diluted_share_growth", 0.20, [(0.0, 20), (0.02, 35), (0.05, 60), (0.10, 85)]),
            MetricSpec("net_share_count_change", 0.15, [(-0.02, 15), (0.0, 30), (0.03, 55), (0.08, 80)]),
            MetricSpec("buyback_offset_ratio", 0.10, [(0.0, 70), (0.5, 55), (1.0, 40), (2.0, 20)]),
            MetricSpec("issuance_pressure", 0.10, [(0.0, 15), (0.2, 40), (0.5, 65), (1.0, 85)]),
        ],
    ),
    BlockSpec(
...
# Overall Quality Risk Score block weights. Sum to 1.0. V0 heuristic.
BLOCK_WEIGHTS: dict[str, float] = {
    "Earnings Quality": 0.18,
    "Cash Conversion": 0.15,
    "Revenue Quality": 0.13,
    "Working Capital Stress": 0.10,
    "Capital Integrity": 0.12,
    "Capex Discipline": 0.10,
    "Balance Sheet Stress": 0.10,
    "Narrative Drift": 0.12,
}
...
V0_WEIGHTS_CAVEAT = (
    "Scores use v0 heuristic weights and thresholds that are neither backtested "
    "nor sector-normalized. Treat as a screening aid, not a calibrated probability."
)
